    ...
    public class Conexiondb
    {
        ...
        public Conexiondb()
        {
            try
            {
                ...
                string cadenaConexion = "server=localhost;Port=3306;user id=Patrichenko;password=**Coco2004**;database=motorsvalue;persistsecurityinfo=True"; conexion = new MySqlConnection(cadenaConexion);
